        ...
        <section class="relative h-[85vh] min-h-[600px] flex items-center justify-center">
            ...
            <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mt-16">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                    <a href="/properties" class="w-full sm:w-auto px-8 py-4 bg-white border-2 border-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-xl">
                        Book Your Stay
                    </a>
                    <a href="/resort-map" class="w-full sm:w-auto px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300 shadow-lg">
                        Explore Resort Map
                    </a>
                </div>
            </div>
